    ...
    sections: [
      {
        ...
        content: "California's existing EV charging network consists of 493 unique locations with DC fast charging stations. This infrastructure has been crucial in supporting the state's growing EV adoption."
      },
      {
        heading: "Optimization Strategy",
        content: "The new suggested charging stations, determined through K-means clustering analysis, aim to enhance the existing network by strategically placing chargers where they are most needed. This data-driven approach offers several key benefits:"
      },
      {
      ...
      {showPopup && report && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg max-w-2xl max-h-[80vh] overflow-auto">
            <h2 className="text-2xl font-bold mb-4 text-black">{report.title}</h2>
            {report.sections.map((section, index) => (
              <div key={index} className="mb-4">
                <h3 className="text-xl font-semibold mb-2 text-black">{section.heading}</h3>
